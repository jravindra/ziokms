...
public class PostMessage {
	...
	@When("^I post cat payload from file (.*) to (.*)$")
	public void iPostCatPayloadFromFile(String file, String url)
	...
	@Then("^the post response for cat is (.*)$")
	public void thePostResponseForCatIs(String status) {
